 ...
 * Copyright © 2011-2012 of Parts (CMD supports) of Code BMDC++ , https://launchpad.net/bmdc++
 * 
...
bool SearchADL::showPropertiesDialog_gui(ADLSearch &search, bool edit, SearchADL *s)
{
	...
	///CMD
	raw = s->find_raw(gtk_combo_box_get_active_text(GTK_COMBO_BOX(s->getWidget("comboboxAction"))));
