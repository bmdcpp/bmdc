...
public:
	...
	enum StrSetting { STR_FIRST,
		...
		//[BMDC++
		LOG_FILE_RAW, LOG_FORMAT_RAW, PROTECTED_USERS, BACKUP_FILE_PATTERN, BACKUP_TIMESTAMP,
		STR_LAST };
	...
	enum IntSetting { INT_FIRST = STR_LAST + 1,
		...
		USERS_FILTER_ONLINE, USERS_FILTER_FAVORITE, USERS_FILTER_QUEUE, USERS_FILTER_WAITING, USE_OEM_MONOFONT,
		//[BMDC+
		TIME_RECCON, ENB_LUA_DEBUG, USE_IP, DETECTIONF, DETECTIONS, FAV_USER_IS_PROTECTED_USER, USE_SEND_DELAYED_RAW,
        LOG_RAW_CMD, ADLSEARCH_DEFAULT_ACTION, MIN_POINTS_TO_DISPLAY_CHEAT, SHOW_ADLSEARCH_DEFAULT_ACTION,
        DCPP_EMULATION_RAW, FILELIST_VERSION_MISMATCH, SHOW_FILELIST_VERSION_MISMATCH,
        USE_WILDCARDS_TO_PROTECT, DISPLAY_CHEATS_IN_MAIN_CHAT, VERSION_MISMATCH_RAW,
        AUTOBACKUP_TIME, ENABLE_AUTOBACKUP, SHOW_FREE_SLOTS_DESC, CHECK_DELAY,
        MAX_TESTSURS, MAX_FILELISTS, CHECK_ALL_CLIENTS_BEFORE_FILELISTS, SLEEP_TIME,
        UNCHECK_CLIENT_PROTECTED_USER, UNCHECK_LIST_PROTECTED_USER, PERCENT_FAKE_SHARE_TOLERATED,
        SHOW_FAKESHARE_RAW, FAKESHARE_RAW, MIN_FL_SIZE, LISTLEN_MISMATCH,
        VERSION_MISMATCH, DISCONNECT_RAW, FILELIST_TOO_SMALL_BIG_RAW,
        SDL_RAW, SHOW_DCPP_EMULATION, LISTLEN_MISMATCH_SHOW,
        SHOW_DISCONNECT, USE_SDL_KICK, MAX_DISCONNECTS,
        SDL_SPEED, SDL_TIME, RMDC_RAW, FILELIST_TOO_SMALL_BIG, SHOW_RMDC,
        ADL_RAW, FILELIST_NA_RAW, SHOW_FILELIST_NA, THROTTLE_ENABLE,
        //]
		INT_LAST };
