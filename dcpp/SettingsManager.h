...
public:
	...
	enum StrSetting { STR_FIRST,
		...
		SOUND_MAIN_CHAT, SOUND_PM, SOUND_PM_WINDOW, LOG_FORMAT_RAW, LOG_RAW_FILE,
		PROTECTED_USERS, COUNTRY_FORMAT, BACKUP_TIMESTAMP, BACKUP_FILE_PATTERN,
		STR_LAST };
	...
	enum IntSetting { INT_FIRST = STR_LAST + 1,
		...
		SLOTS_ALTERNATE_LIMITING, SLOTS_PRIMARY, SHOW_FREE_SLOTS_DESC, USE_IP, USE_COUNTRY, DETECTT, DETECTF,
		UPDATE_PROFILE_CHEATS, UPDATE_PROFILE_COMMENTS, MIN_FL_SIZE, FILELIST_TOO_SMALL_BIG, MAX_DISCONNECTS,
		CHECK_DELAY, MAX_TESTSURS, MAX_FILELISTS, CHECK_ALL_CLIENTS_BEFORE_FILELISTS, SLEEP_TIME, OVERLAP_CHUNKS,
		FILE_SLOTS, ADLSEARCH_DEFAULT_ACTION, MIN_POINTS_TO_DISPLAY_CHEAT, SHOW_ADLSEARCH_DEFAULT_ACTION, LOG_RAW_CMD,
		USE_SEND_DELAYED_RAW, FAKESHARE_RAW, PERCENT_FAKE_SHARE_TOLERATED, RMDC_RAW, DCPP_EMULATION_RAW,
		FILELIST_VERSION_MISMATCH, LISTLEN_MISMATCH, VERSION_MISMATCH, DISCONNECT_RAW, FILELIST_TOO_SMALL_BIG_RAW,
		LISTLEN_MISMATCH_SHOW, USE_SDL_KICK, SDL_SPEED, SDL_TIME, SDL_RAW,
		SHOW_SDL_RAW, SHOW_FAKESHARE_RAW, SHOW_DISCONNECT_RAW, FAV_USER_IS_PROTECTED_USER, SHOW_FILELIST_VERSION_MISMATCH,
		SHOW_DCPP_EMULATION_RAW, UNCHECK_CLIENT_PROTECTED_USER, UNCHECK_LIST_PROTECTED_USER, SHOW_RMDC_RAW, DISPLAY_CHEATS_IN_MAIN_CHAT,
		SHOW_LISTLEN_MISMATCH, THROTTLE_ENABLE, LOG_FINISHED_DOWNLOADS, ENB_LUA_DEBUG, TIME_RECCON, USE_WILDCARDS_TO_PROTECT,
		AUTOBACKUP_TIME, ENABLE_AUTOBACKUP,
		INT_LAST };
